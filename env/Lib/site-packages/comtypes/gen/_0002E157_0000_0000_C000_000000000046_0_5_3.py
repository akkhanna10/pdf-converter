...
__all__ = [
    'VBE', 'vbextFileTypeDesigners', 'vbext_wt_MainWindow',
    'vbext_pk_Set', 'vbext_wt_ProjectWindow',
    'vbext_wt_PropertyWindow', 'vbext_wt_Locals', 'Components',
    'CommandBarEvents', '_CodeModule', '_VBProjectsEvents',
    '_Windows_old', '_dispVBProjectsEvents', 'vbext_pk_Get',
    '_Components', 'vbextFileTypePropertyPage', 'vbextFileTypeClass',
    'vbextFileTypeUserControl', 'vbextFileTypeForm',
    '_VBComponentsEvents', 'References', 'vbext_vm_Break',
    '_VBComponent_Old', '_CodePanes', '_VBProject_Old',
    '_LinkedWindows', 'vbext_wt_CodeWindow', 'vbext_wt_Watch',
    '_VBProjects_Old', 'vbext_WindowState', 'vbext_wt_Find',
    'vbext_ComponentType', '_dispReferences_Events', 'VBProjects',
    'vbext_pt_StandAlone', 'vbextFileTypeRes', 'vbext_pt_HostProject',
    '_ProjectTemplate', 'vbextFileTypeGroupProject',
    'vbext_wt_Designer', 'Application', 'vbext_ProjectProtection',
    'vbext_ws_Normal', 'vbext_wt_Browser', '_Component',
    '_VBComponent', 'vbext_VBAMode', 'Addins',
    '_dispCommandBarControlEvents', 'VBComponent', 'vbext_pp_none',
    'vbext_wt_LinkedWindowFrame', 'vbext_wt_Immediate',
    'vbext_wt_Toolbox', '_VBProject', 'vbextFileTypes',
    'vbext_wt_ToolWindow', 'AddIn', 'SelectedComponents',
    '_References', 'ReferencesEvents', 'vbext_pk_Let',
    'vbext_WindowType', 'vbext_cv_ProcedureView', '_VBComponents',
    '_CommandBarControlEvents', 'vbext_ct_StdModule',
    'vbextFileTypeExe', 'vbextFileTypeProject', '_CodePane',
    '_Windows', 'vbextFileTypeDocObject', '_dispReferencesEvents',
    'vbext_wt_FindReplace', 'vbext_ProjectType', 'Property',
    'ProjectTemplate', 'vbext_cv_FullModuleView', 'vbext_pk_Proc',
    '_AddIns', 'vbext_ws_Minimize', 'vbext_CodePaneview',
    'vbext_ct_ClassModule', 'vbext_ws_Maximize', 'vbextFileTypeFrx',
    'CodePane', 'vbext_ProcKind', 'vbext_pp_locked', 'Component',
    'CodePanes', 'Events', '_Properties', 'vbext_ct_ActiveXDesigner',
    'vbextFileTypeBinary', 'vbext_ct_MSForm', 'vbextFileTypeModule',
    'LinkedWindows', '_ReferencesEvents', 'vbext_rk_TypeLib',
    'VBProject', 'VBComponents', '_VBComponents_Old',
    'vbext_rk_Project', 'vbext_vm_Run', '_dispVBComponentsEvents',
    'Window', '_VBProjects', 'vbext_ct_Document', 'vbext_RefKind',
    'vbext_vm_Design', 'CodeModule', 'Reference', 'Windows',
    'Properties'
]

_check_version('1.2.0', 1637593067.270406)
